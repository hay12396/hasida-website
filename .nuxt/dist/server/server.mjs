...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${__vite_ssr_import_6__.ssrRenderAttrs(__vite_ssr_import_5__.mergeProps({ class: "wrapper" }, _attrs))} data-v-c07c5a78><div class="square" data-v-c07c5a78></div><div class="hero" data-v-c07c5a78><!-- <div class="title">Mr. Pro Shake</div> --><div class="sub-title" data-v-c07c5a78> The new way to order protein shakes, <br data-v-c07c5a78><b data-v-c07c5a78>discover</b> a new taste every day. </div><div class="figma-links" data-v-c07c5a78>`)
