...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${__vite_ssr_import_6__.ssrRenderAttrs(__vite_ssr_import_5__.mergeProps({ class: "wrapper" }, _attrs))} data-v-c07c5a78><div class="square" data-v-c07c5a78></div><div class="hero" data-v-c07c5a78><div class="title" data-v-c07c5a78>Mr. Pro Shake</div><div class="sub-title" data-v-c07c5a78> The new way to order protein shakes, <br data-v-c07c5a78><b data-v-c07c5a78>discover</b> a new taste every day. </div><div class="figma-links" data-v-c07c5a78>`)
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`</div><div class="info" data-v-08ee70f2><div class="img-wrapper" data-v-08ee70f2>`)
  _push(__vite_ssr_import_4__.ssrRenderComponent(_component_Image, {
    src: "/me.png",
    alt: "me"
  }, null, _parent))
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><div class="header"><div class="circle circle1"></div><div class="circle circle2"></div><div class="circle circle3"></div><div class="circle circle4"></div><div class="circle circle5"></div><img${__vite_ssr_import_15__.ssrRenderAttr("src", $options.getImageSrc())} alt="Hasida Zohar"></div>`)
